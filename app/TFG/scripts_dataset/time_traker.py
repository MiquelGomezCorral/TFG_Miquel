...
class TimeTracker:
    def __init__(self, name: str, start_track_now: bool = False ):
        ...
        print_separator(f"⏳ TIME TRACKER '{name}' INITIALIZED{'. STARTING NOW' if start_track_now else ''}! ⏳", sep_type="SUPER")
    ...
    def track(self, tag: str, verbose: bool = True, space: bool = True, mute_warning: bool = False) -> float:
        """
