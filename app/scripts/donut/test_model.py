...
from scripts.dataset.validate_model import validate_model

from src.utils.utils import print_separator
from src.utils.time_traker import print_time
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="data/final_dataset_fatura"  #"naver-clova-ix/cord-v1"
    )
    parser.add_argument(
        "--split", type=str,
        default="test"
    ...
    parser.add_argument(
        "--save_path", type=str,
        default="src/outputs/fatura_test/output.json"
    )
